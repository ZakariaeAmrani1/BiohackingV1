...
export class AppSettingsService {
  ...
  // Get theme options
  static getThemeOptions(): { value: AppSettings['theme']; label: string; description: string }[] {
    return [
      { 
        value: 'light', 
        label: 'Clair', 
  ...
  static getFontSizeOptions(): { value: AppSettings['fontSize']; label: string; description: string }[] {
    return [
      { 
        value: 'small', 
        label: 'Petite', 
  ...
  static getLanguageOptions(): { value: AppSettings['language']; label: string }[] {
    return [
